...
export default function PaymentPage() {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-slate-100 to-slate-200 -pt-22 flex items-center justify-center px-4">
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-xl p-6 md:p-8">
        ...
        <div className="mt-6 bg-slate-100 border border-dashed border-slate-300 rounded-xl p-4 text-center">
          <p className="text-sm text-slate-500">Send Money Number</p>
